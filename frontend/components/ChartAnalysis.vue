            ...
            <div
                ...
                <div>
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        data-popper-escaped=""
                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(939px, 213px, 0px);">
        ...
        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            <div class="bg-white rounded-lg dark:bg-gray-800">
                <div class="flex justify-between">
                    <div>
                        <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-2">Total Capital Gains</h5>
...
const getAccumulatedData = (field: string) => {
    return computed(() => {
...
const getColumnChartOptions = (data, field1, field2, accumulatedField) => {
    return {
        colors: ["#1A56DB", "#FDBA8C", "#9061F9", "#16BDCA", "#E74694"],
        series: processDataAndFormatForApexCharts(data, field1, field2, accumulatedField),
        chart: {
            type: "bar",
            height: 420,
            fontFamily: "Inter, sans-serif",
